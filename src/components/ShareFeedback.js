...
import { setShowFeedback, setShowMenu, submitContact, submitFeedback, submitReport, submitSuggestion, toggleShowButton} from '../utils/configSlice'
...
const ShareFeedback = () => {
  ...
  return (
    <div className=' -z-10 md:z-0 bg-white text-black w-[300px] md:w-[450px] h-[400px] md:h-[476px] pl-2 md:pl-[24px] pr-2 md:pr-[16px] pt-4 md:pt-[24px] pb-4 md:pb-[16px]  '>
          <img className=' p-2' src='../Header - Issue 1 (3).png' alt='label'/>
